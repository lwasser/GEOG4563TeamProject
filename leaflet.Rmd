...
leaflet(CalCen) %>% addProviderTiles(providers$OpenMapSurfer.Roads) %>% addPolygons(color = "#444444", weight = 1, smoothFactor = 0.5,
    opacity = 1.0, fillOpacity = 0.5,
    fillColor = ~colorQuantile("YlOrRd", CalCen$Total)(CalCen$Total),
