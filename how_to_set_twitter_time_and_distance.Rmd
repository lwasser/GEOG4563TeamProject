---
title: "make_twitter_file_smaller"
...
```{r}
twitter_data <- read.csv("data/twitter/eq.csv")
...
twitter_data <- subset(twitter_data, 
                             twitter_data$Timestamp >= ('2014-07-24 04:20:00') &
                            twitter_data$Timestamp <= ('2014-09-24 04:29:59') )

# subset data:  30days +/-from earthquake
twitter_data <- subset(twitter_data, twitter_data$Timestamp >= as.POSIXct('2014-08-23 0:00:00') &
                            twitter_data$Timestamp <= as.POSIXct('2014-09-24 12:59:59') )
...
# write.csv(twitter_data, "twitter_31days.csv")
```
